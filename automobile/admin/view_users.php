...
<div class="shell">
  ...
  <div id="header">
    ...
    <div id="nav">
       <ul>
        ...
        <li><a class="active" href="view_users.php">Users</a></li>
  ...
  <ul>
  <?php
	$sql="select * from users where status <>'removed' order by id DESC";
    ...
    <li>
     ...
     <a href="../users/images/<?php echo $image;?>" target="_blank" title="Click on to view full image"><img src="../users/images/<?php echo $image;?>" alt="no image"  width="100" height="90"/></a>
     <span style="margin-left:20px;"> <a href="single_user.php?id=<?php echo $id;?>"><?php echo $name;?></a></span>
